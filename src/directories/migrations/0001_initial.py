    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor_image', models.ImageField(blank=True, upload_to='autor/')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
                ...
                ('genre_image', models.ImageField(blank=True, upload_to='genre/')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_image', models.ImageField(blank=True, default='/book/book-default.jpg', upload_to='book/')),
                ...
                ('rating', models.DecimalField(decimal_places=0, default=0, max_digits=2, verbose_name='Rating')),
